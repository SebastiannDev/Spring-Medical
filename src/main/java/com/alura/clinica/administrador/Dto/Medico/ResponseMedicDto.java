...
public record ResponseMedicDto(Long id, String nombre, String email, String identificacion, String telefono,
        Boolean activo,
        DireccionDto direccionDto, Especialidad especialidad) {

    public ResponseMedicDto(Medico medic) {
        this(medic.getId(), medic.getNombre(), medic.getEmail(), medic.getIdentificacion(), medic.getTelefono(),
                medic.getActivo(),
